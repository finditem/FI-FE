...
const LoginRequiredNotice = () => {
  const t = useTranslations("LoginRequiredNotice");
        ...
        ? createPortal(
            ...
            >
              <div className="relative rounded-2xl p-[10px] shadow-sm bg-fill-brand-subtle-default_2">
                ...
                <div
                  className="pointer-events-none absolute left-1/2 top-full h-[6px] w-[12px] -translate-x-1/2 -translate-y-px bg-fill-brand-subtle-default_2 [clip-path:polygon(50%_100%,0_0,100%_0)]"
                  aria-hidden
                />
              </div>
            </div>,
