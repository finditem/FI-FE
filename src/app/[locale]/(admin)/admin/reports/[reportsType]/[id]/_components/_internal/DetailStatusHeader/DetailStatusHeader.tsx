...
} from "@/app/[locale]/(admin)/admin/_utils/AdminStatusBadgeConfig/AdminStatusBadgeConfig";
...
import AdminDropdown from "@/app/[locale]/(admin)/admin/_components/AdminDropdown/AdminDropdown";
